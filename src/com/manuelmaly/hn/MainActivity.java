...
public class MainActivity extends BaseListActivity implements
	...
	public void init() {
		...
		TextView orderByReader = (TextView) findViewById(R.id.orderByReader);
		TextView orderByComment = (TextView) findViewById(R.id.orderByComment);
		TextView mSettings = (TextView) findViewById(R.id.mSettings);
		TextView mAbout = (TextView) findViewById(R.id.mAbout);
		TextView mFavorite = (TextView) findViewById(R.id.mFavorite);
		...
		startFeedLoading();
		/*
		 * mPostsList.setOnTouchListener(new OnTouchListener() {
		 * 
	...
	class PostsAdapter extends BaseAdapter {
		...
		public View getView(final int position, View convertView,
			...
			case VIEWTYPE_POST:
				 ...
				 * (Settings.getHtmlViewer(MainActivity.this).equals(
				 * getString(R.string.pref_htmlviewer_browser)))
				 * openURLInBrowser( getArticleViewURL(getItem(position)),
				 * MainActivity.this); else openPostInApp(getItem(position),
	...
	class DefaultGestureDetector extends SimpleOnGestureListener {
		...
		public boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
			...
			if ((e1.getX() - e2.getX()) > FLING_MIN_DISTANCE
				...
				Toast.makeText(MainActivity.this, "slide left",
						Toast.LENGTH_SHORT).show();
			else if ((e2.getX() - e1.getX()) > FLING_MIN_DISTANCE
					&& Math.abs(velocityX) > FLING_MIN_VELOCITY)
				Toast.makeText(MainActivity.this, "slide right",
						Toast.LENGTH_SHORT).show();
			return false;
		}
	}
